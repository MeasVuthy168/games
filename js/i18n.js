...
export const translations = {
  en: {
    ...
    'notif.message': '{name}: {preview}',
    'notif.groupedMessages': '{name} sent you {count} messages',
    'notif.gameInvite': '{name} challenged you to a game',
    'notif.gameAccepted': '{name} accepted your challenge',
    'notif.gameMove': "It's your move against {name}",
    'notif.gameOverDraw': 'Your game with {name} ended in a draw',
    'notif.gameOverWinResignation': 'Game over vs {name} — {color} won by resignation',
    'notif.gameOverWin': 'Game over vs {name} — {color} won',
    'notif.colorWhite': 'White',
    'notif.colorBlack': 'Black',
    'notif.timeJustNow': 'just now',
    'notif.timeMinAgo': '{n}m ago',
    'notif.timeHourAgo': '{n}h ago',
    'notif.empty': 'No notifications yet.',
    'notif.emptyDisabled': 'Notifications are turned off. Enable them in Settings to see friend, chat, and game activity.',
    'notif.signInTitle': 'Sign in to see notifications',
    'notif.signInSub': 'Friend requests, accepted friends, and chat messages',
    'notif.markAllRead': 'Mark all read',
    'notif.deleteAll': 'Delete all',
    'notif.deleteAllConfirm': 'Delete all notifications? This cannot be undone.',
    'notif.swipeRead': 'Read',
    'notif.swipeDelete': 'Delete',
    ...
    'result.drawRepetition': 'Draw by Repetition!',
    'result.drawRepetitionDesc': 'The same position occurred three times.',
    ...
    'ai.provider.thinking': 'Thinking…',
    'ai.provider.calculating': 'Calculating…',
    ...
    'chat.menuCopy': 'Copy',
    'chat.menuReply': 'Reply',
    'chat.menuPin': 'Pin',
    'chat.menuUnpin': 'Unpin',
    'chat.menuInfo': 'Info',
    'chat.menuDeleteMe': 'Delete for me',
    'chat.menuDeleteEveryone': 'Delete for everyone',
    ...
    'chat.timeNow': 'now',
    'chat.timeMinShort': '{n}m',
    'chat.timeHourShort': '{n}h',
    'chat.timeDayShort': '{n}d',
    'chat.youPrefix': 'You: ',
    'chat.sayHello': 'Say hello!',
    'chat.swipeRead': 'Read',
    'chat.swipeMore': 'More',
    'chat.menuMarkUnread': 'Mark as unread',
    'chat.menuMute': 'Mute',
    'chat.menuUnmute': 'Unmute',
    'chat.menuDeleteConv': 'Delete',
    'chat.menuUnfriend': 'Unfriend',
    'chat.deleteConvConfirm': 'Delete this conversation? It will stay deleted until a new message arrives.',
    'chat.actionFailed': 'Could not complete that action',
    ...
    'watch.resultPlayerWins': '{name} wins',
  ...
  km: {
    ...
    'notif.friendRequest': '{name} បានផ្ញើសំណើមិត្តភក្តិមកអ្នក',
    'notif.friendAccepted': '{name} បានទទួលយកសំណើមិត្តភក្តិរបស់អ្នក',
    'notif.message': '{name}៖ {preview}',
    'notif.groupedMessages': '{name} បានផ្ញើសារមកអ្នក {count} សារ',
    'notif.gameInvite': '{name} បានប្រកួតប្រជែងអ្នកលេងល្បែងមួយ',
    'notif.gameAccepted': '{name} បានទទួលយកការប្រកួតប្រជែងរបស់អ្នក',
    'notif.gameMove': 'វេនអ្នកលេងជាមួយ {name}',
    'notif.gameOverDraw': 'ល្បែងរបស់អ្នកជាមួយ {name} ស្មើគ្នា',
    'notif.gameOverWinResignation': 'ល្បែងចប់ជាមួយ {name} — {color} ឈ្នះដោយការចុះចាញ់',
    'notif.gameOverWin': 'ល្បែងចប់ជាមួយ {name} — {color} ឈ្នះ',
    'notif.colorWhite': 'ស',
    'notif.colorBlack': 'ខ្មៅ',
    'notif.timeJustNow': 'ទើបតែឥឡូវ',
    'notif.timeMinAgo': '{n} នាទីមុន',
    'notif.timeHourAgo': '{n} ម៉ោងមុន',
    'notif.empty': 'មិនទាន់មានការជូនដំណឹងទេ។',
    'notif.emptyDisabled': 'ការជូនដំណឹងត្រូវបានបិទ។ បើកវានៅក្នុងការកំណត់ ដើម្បីមើលសកម្មភាពមិត្តភក្តិ ជជែក និងល្បែង។',
    'notif.signInTitle': 'ចូលគណនីដើម្បីមើលការជូនដំណឹង',
    'notif.signInSub': 'សំណើមិត្តភក្តិ មិត្តភក្តិដែលបានទទួល និងសារជជែក',
    'notif.markAllRead': 'សម្គាល់ថាអានទាំងអស់',
    'notif.deleteAll': 'លុបទាំងអស់',
    'notif.deleteAllConfirm': 'លុបការជូនដំណឹងទាំងអស់? សកម្មភាពនេះមិនអាចត្រឡប់វិញបានទេ។',
    'notif.swipeRead': 'អាន',
    'notif.swipeDelete': 'លុប',
    'notif.loadError': 'មិនអាចផ្ទុកការជូនដំណឹងបានទេ។',
    ...
    'result.drawRepetition': 'ស្មើដោយដំណើរដដែលៗ!',
    'result.drawRepetitionDesc': 'ទីតាំងដូចគ្នាកើតឡើងបីដង។',
    ...
    'ai.provider.thinking': 'កំពុងគិត…',
    'ai.provider.calculating': 'កំពុងគណនា…',
    ...
    'chat.menuCopy': 'ចម្លង',
    'chat.menuReply': 'ឆ្លើយតប',
    'chat.menuPin': 'ខ្ទាស់',
    'chat.menuUnpin': 'ដកខ្ទាស់',
    'chat.menuInfo': 'ព័ត៌មាន',
    'chat.menuDeleteMe': 'លុបសម្រាប់ខ្ញុំ',
    'chat.menuDeleteEveryone': 'លុបសម្រាប់អ្នកទាំងអស់',
    ...
    'chat.timeNow': 'ឥឡូវ',
    'chat.timeMinShort': '{n}នាទី',
    'chat.timeHourShort': '{n}ម៉ោង',
    'chat.timeDayShort': '{n}ថ្ងៃ',
    'chat.youPrefix': 'អ្នក៖ ',
    'chat.sayHello': 'សួស្តី!',
    'chat.swipeRead': 'អាន',
    'chat.swipeMore': 'ច្រើនទៀត',
    'chat.menuMarkUnread': 'សម្គាល់ថាមិនទាន់អាន',
    'chat.menuMute': 'បិទសំឡេង',
    'chat.menuUnmute': 'បើកសំឡេង',
    'chat.menuDeleteConv': 'លុប',
    'chat.menuUnfriend': 'ដកមិត្ត',
    'chat.deleteConvConfirm': 'លុបការសន្ទនានេះ? វានឹងបាត់រហូតដល់មានសារថ្មីមកដល់។',
    'chat.actionFailed': 'មិនអាចធ្វើសកម្មភាពនេះបានទេ',
    ...
    'watch.resultPlayerWins': '{name} ឈ្នះ',
