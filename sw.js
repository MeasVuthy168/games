...
const CORE = [
  ...
  './tournament.html','./rewards.html','./ai-vs-ai.html','./watch.html',
  './auth.html','./reset-password.html','./verify-email.html','./chat.html',
  './styles.css','./js/main.js','./js/ui.js','./js/ai.js','./js/ai-engine.js','./js/ai-worker.js','./js/game.js','./js/pwa.js','./js/settings.js','./js/profile.js','./js/watch.js',
  ...
  './js/api.js','./js/auth-page.js','./js/reset-password-page.js','./js/verify-email-page.js','./js/friends-page.js','./js/chat-page.js','./js/chat-badge.js','./js/notifications-page.js','./js/notif-badge.js','./js/push-client.js',
  ...
  './assets/ui/nav-home.png','./assets/ui/nav-friends.png','./assets/ui/nav-chat.png','./assets/ui/nav-play.png','./assets/ui/nav-settings.png','./assets/ui/nav-bell.png',
